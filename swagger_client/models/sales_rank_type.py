...
class SalesRankType(object):
    ...
    def __init__(self, product_category_id=None, rank=None, _configuration=None):  # noqa: E501
    ...
    def product_category_id(self, product_category_id):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and product_category_id is None:
